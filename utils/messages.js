 ...
 * @return {String} a message with the email of the user repeated
 */
 ...
 * @return {String} a message with the email of the user that is not found
 */
 ...
 * @return {String} a message with the name of the role repeated
 */
 ...
 * @return {String} a message advising that the user already has the role requested to assign
 */
 ...
 * @return ra message advising that the user does not have the role requested
 */
 ...
 * @param {String} roleName role name
 * @return a message advising that the role has been removed from the user
 */
 ...
 * @return {String} a message with the type of object created on database
 */
 ...
 * @param {String} object the type of object that has been created
 * @return {String} a message saying that the object type has been updated
 */
 ...
 * @param {String} object the type of object that has been created
 * @return {String} a message saying that the object type has been deleted
 */
const deletedMessage = (object) => `The ${object} has been deleted succesfully`;

/**
 * function to use when a generic error happens
 * @return {String} a generic message to unhandled errors
 */
 ...
 * @return a message saying that the object that is searched does not exists
 */
 ...
 * @return a message saying that the object with the specific attribute already exists on database
 */
 ...
 * @return a message saying that the object is already active on database
 */
 ...
 * @return a message saying that the object is already unactive on database
 */
 ...
 * @return a message sayung that the object with the specific data already exists
 */
 ...
 * @return a generic message saying that the request has not been made correctly
 */
 ...
 * @return a message saying that the requested content is empty
 */
 ...
 * @return a message saying that ther are no updated fields
 */
 ...
 * @return a message saying that the requested was made correctly
 */
 ...
 * @return a message saying that user had a succesfull login
 */
const succesfullLoginMessage = () => `Succesfull login!`;

/**
 * function to use when a user attempts a incorrect login
 * @return a message saying that the password o email/username is incorrect
 */
 ...
 * @return a messages saying to user to login again
 */
 ...
 * @return a message saying that the user needs to login
 */
 ...
 * @return a message saying that the user's access is forbiden
 */
